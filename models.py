...
class Servicos(models.Model):
    ...
    port_number = models.IntegerField(max_length=4)
...
class Dhcp(models.Model):
    ...
    id_domain = models.IntegerField(max_length=2)
    gateway = models.GenericIPAddressField()
    opcao = models.IntegerField(max_length=2)
